...
def create_app(config_name=None):
            ...
            'schemas': {
                ...
                'CaseStudy': {
                    ...
                    'properties': {
                        ...
                        'video_created_at': {'type': 'string', 'format': 'date-time'},
                        'newsflash_video_url': {'type': 'string'},
                        'newsflash_video_id': {'type': 'string'},
                        'newsflash_video_status': {'type': 'string'},
                        'newsflash_video_created_at': {'type': 'string', 'format': 'date-time'},
                        'pictory_video_status': {'type': 'string'},
                        'pictory_video_url': {'type': 'string'},
                        'pictory_storyboard_id': {'type': 'string'},
                        'pictory_render_id': {'type': 'string'},
                        'pictory_video_created_at': {'type': 'string', 'format': 'date-time'},
                        'podcast_status': {'type': 'string'},
                        'podcast_url': {'type': 'string'},
                        'podcast_job_id': {'type': 'string'},
                        'podcast_script': {'type': 'string'},
                        'podcast_created_at': {'type': 'string', 'format': 'date-time'},
    ...
    app.config.update(
        ...
        MAIL_PASSWORD='bmputopddzkbnuve',  # App Password, not real Gmail password
